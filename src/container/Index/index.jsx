...
import {Tabs, Icon, Table, DatePicker, Divider, Col, Row} from 'antd';
import "./Index.less"
                    ...
                    <TabPane tab="行情" key="2">
                        <div className="market-wrap">
                            ...
                            <div className="market-content-container">
                                <div>
                                    <p>
                                        <span>:当前价：2.594</span><span>涨跌：0.087</span><span>幅度：3.47%</span>
                                    </p>
                                </div>
                                <Table
                            ...
                            <div className="deal-content-container">
                                <div className="my-deal">
                                    <div className="deal-content">
                                        <p>
                                            <span>交易账号：128812091</span><Icon type="eye" theme="outlined" />
                                        </p>
                                        <p className="my-deal-info">
                                            <Row>
                                                <Col span={8}><Row>总权益</Row><Row>977.00</Row></Col>
                                                <Col span={8}><Row>持仓市值</Row><Row>0.00</Row></Col>
                                                <Col span={8}><Row>持仓盈号</Row><Row>0.00</Row></Col>
                                            </Row>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <TabPane tab="我的" key="4">
                        <div className="my-index-wrap">
                            ...
                            <div className="my-info-operation-content">
                                <ul>
                                    <li onClick={()=>{window.location.href = "#/Dashboard/MyRight"}}><p>我的权益</p><Icon type="right" theme="outlined" /></li>
                                    <li onClick={()=>{window.location.href = "#/Dashboard/MyDeal"}}><p>我的成交</p><Icon type="right" theme="outlined" /></li>
                                    <li onClick={()=>{window.location.href = "#/Dashboard/MyEntrust"}}><p>我的委托</p><Icon type="right" theme="outlined" /></li>
                                    <li><p>我的客服</p><Icon type="right" theme="outlined" /></li>
                                    <li><p>版本号<span>v1.0.9</span></p><Icon type="right" theme="outlined" /></li>
                                </ul>
                            </div>
                        </div>
                    </TabPane>
